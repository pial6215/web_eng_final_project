...
class ListingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'price': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Per month rent', 'min': 0}),
    ...
    def clean_bedrooms(self):
        ...
        if bedrooms is not None and bedrooms <= 0:
            raise forms.ValidationError("Number of bedrooms cannot be 0 or negative.")
        return bedrooms
